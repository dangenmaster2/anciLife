...
const UserName = ({userName, setUserNameLocal}) => {
    ...
    return(
        <View style={styles.userInfoContainer}>
            <Text style={{fontSize: 30, fontWeight: 'bold', paddingBottom: 50}}>What should we call you?</Text>
            <InputField placeHolderText='A nickname will be perfect' onChangeText={(text) => setUserNameLocal(text)}/>
        </View>
    )
}
